...
class HomeworkSubmissionController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('permission:homework_submissions.view')->only(['index', 'show']);
        $this->middleware('permission:homework_submissions.create')->only(['store']);
        $this->middleware('permission:homework_submissions.update')->only(['update']);
        $this->middleware('permission:homework_submissions.delete')->only(['destroy']);
    }
